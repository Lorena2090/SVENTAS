...
public class LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnIniciarSesion.setBackground(new java.awt.Color(24, 53, 102));
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
     String pass = new String (txtContraseña.getPassword());
        ...
        if (!txtUsuario.getText().equals("") && !pass.equals("")){
             String clave = Base64.getEncoder().encodeToString(pass.getBytes());
             us.setUSUARIO(txtUsuario.getText());
             us.setCONTRASEÑA(clave);
             if(usDAO.login(us)){  
             PRINCIPAL vist = new PRINCIPAL(us);
             vist.setVisible(true);
            } else {
                JOptionPane.showMessageDialog(null,"Datos Incorrectos");
            }} 
         else {
             JOptionPane.showMessageDialog(null,"Esto para que sera");
        }  
             dispose();
